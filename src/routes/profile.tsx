                ...
                <div className="glass rounded-3xl p-8 border border-purple-500/50 relative overflow-hidden bg-gradient-to-br from-purple-900/20 to-black">
                  ...
                  <div className="relative z-10 flex flex-col md:flex-row gap-6 items-center justify-between">
                    <div>
                      ...
                      <a href="https://discord.gg/HwvBBnX3Wc" target="_blank" className="inline-flex items-center gap-2 mt-4 px-4 py-2 bg-purple-600 hover:bg-purple-500 text-white font-bold rounded-xl transition-all shadow-[0_0_15px_rgba(168,85,247,0.4)]">
