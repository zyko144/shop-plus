...
export const Route = createFileRoute("/premium")({
  ...
  head: () => ({ meta: [{ title: "Devenir VIP Premium — Vercell" }] })
});
  ...
  return (
    <div className="min-h-screen pb-20 selection:bg-gray-500/30">
      ...
      <main className="max-w-6xl mx-auto px-6 py-12 md:py-20 relative">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-gray-600/20 rounded-full blur-[120px] pointer-events-none -z-10"></div>
        
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          
          {/* Section Texte / Explications */}
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-700">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gray-500/10 border border-gray-500/30 text-gray-400 font-bold text-sm">
              <Star size={16} className="fill-gray-500" /> Le club le plus fermé
            </div>
            
            <h1 className="font-display text-5xl md:text-6xl font-black leading-tight">
              Passez au niveau supérieur avec <span className="text-transparent bg-clip-text bg-gradient-to-r from-gray-400 to-gray-500">Premium VIP</span>.
            </h1>
            ...
            <ScrollReveal as="div" stagger className="space-y-4 pt-4">
              <div className="flex items-start gap-4 p-4 rounded-2xl bg-white/5 border border-white/10 hover:border-gray-500/30 transition-colors">
                <div className="w-10 h-10 shrink-0 rounded-full bg-gray-500/20 flex items-center justify-center text-gray-400 mt-1">
                  <Crown size={20} />
                </div>
                <div>
          ...
          <ScrollReveal as="div" y={40} className="lg:justify-self-end w-full max-w-md">
            <div className="glass rounded-[2.5rem] p-8 border-2 border-gray-500/50 relative overflow-hidden group hover:border-gray-400 transition-colors shadow-[0_0_50px_rgba(255,255,255,0.2)]">
              <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-gray-500/20 to-gray-500/20 blur-[60px] rounded-full group-hover:scale-110 transition-transform"></div>
              
              <div className="relative z-10 text-center space-y-6">
                <div className="w-20 h-20 mx-auto rounded-3xl bg-gradient-to-tr from-gray-600 to-gray-500 flex items-center justify-center text-white shadow-xl shadow-gray-500/30">
                  <Crown size={40} />
                </div>
                ...
                <div>
                  ...
                  <div className="flex items-end justify-center gap-1">
                    <span className="text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-gray-400 to-gray-400">5€</span>
                ...
                <button 
                  ...
                  className="w-full py-4 rounded-2xl bg-gradient-to-r from-gray-600 to-gray-500 text-white font-black text-lg hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2 shadow-[0_0_30px_rgba(255,255,255,0.4)]"
                >
