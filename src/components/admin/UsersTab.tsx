              ...
              <tr key={u.id} className="hover:bg-white/5 transition-colors">
                ...
                <td className="p-4">
                  {u.is_premium ? (
                    <div className="flex flex-col gap-1">
                      <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-bold bg-gray-500/20 text-gray-400 w-fit">
                        👑 Premium Actif
                      </span>
                ...
                <td className="p-4 text-right">
                  <button
                    ...
                    className="px-4 py-2 bg-gradient-to-r from-gray-600 to-gray-600 hover:from-gray-500 hover:to-gray-500 text-white rounded-lg text-sm font-bold shadow-lg shadow-gray-500/25 transition-all active:scale-95"
                  >
                    Accorder Premium (-30%)
                  </button>
                </td>
