...
import { t as AuthProvider } from "./auth-C8BY853h.mjs";
...
import { _ as MessageCircle, h as Pause, i as Volume2, m as Play, n as X, r as VolumeX, s as Ticket, y as ExternalLink } from "../_libs/lucide-react.mjs";
import { t as QueryClient } from "../_libs/tanstack__query-core.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-DoTCsaoJ.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-Dz_W-pv1.css";
...
function AudioPlayer() {
	...
	const [volume, setVolume] = (0, import_react.useState)(.2);
	...
	const togglePlay = () => {
		if (audioRef.current) {
			...
			else audioRef.current.play().catch((e) => console.error("Autoplay blocked:", e));
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: "Barbie ft. RK - Le Crime"
				})]
			}),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					onClick: () => setVolume(volume === 0 ? .2 : 0),
					className: "text-white/60 hover:text-white transition-colors",
					children: volume === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(VolumeX, { size: 16 }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Volume2, { size: 16 })
...
var $$splitComponentImporter$2 = () => import("./orders-BmhVTazh.mjs");
var Route$2 = createFileRoute("/orders")({
	head: () => ({ meta: [{ title: "Mes commandes — ZYKO Store" }] }),
	component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
var $$splitComponentImporter$1 = () => import("./auth-Bqt8GUJC.mjs");
...
var $$splitComponentImporter = () => import("./routes-BZtwycO7.mjs");
