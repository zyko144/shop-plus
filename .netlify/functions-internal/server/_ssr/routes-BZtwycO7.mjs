...
import { b as Check, c as Sparkles, d as ShieldCheck, f as Search, p as Plus, t as Zap, u as ShoppingBag } from "../_libs/lucide-react.mjs";
import { a as FORTNITE_RARE, c as STREAMING, d as VPN, i as FORTNITE_CLASSIC, l as TWITCH, n as CartDrawer, o as Header, r as DISCORD_DECO, s as STEAM_CATEGORIES, t as CATEGORY_IMAGES, u as VBUCKS } from "./CartDrawer-jnxOCeQX.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-BZtwycO7.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function hex(c) {
	return c.replace("#", "");
}
function ProductCard3D({ product }) {
	const { add } = useCart();
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		style: { boxShadow: hover ? `0 30px 80px -20px ${product.color}80, 0 0 0 1px ${product.color}55 inset` : `0 10px 40px -15px #000` },
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					style: {
						color: product.color,
						textShadow: `0 0 24px ${product.color}90`
					},
					...
					children: added ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, { size: 16 }), " Ajouté"] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Plus, { size: 16 }), " Panier"] })
				})]
			})]
		})]
	});
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CategorySidebar, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: filtered.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ProductCard3D, { product: p }, p.id))
						})
